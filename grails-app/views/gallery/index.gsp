...
<g:set var="type" value="${params?.type?.encodeAsHTML()}" />
<html>
    <head>
        ...
        <title>${type?.capitalize()} Gallery</title>
    </head>
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            var serviceURI = serviceURL + '/gallery/findAll${type?.capitalize()}s.json?type=${type}' + '&max=' + max + '&offset=' + offset;
